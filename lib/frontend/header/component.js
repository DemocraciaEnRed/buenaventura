        ...
        <div className='container header-items-wrapper'>
          ...
          <div className='header-items'>
            <div className="header-item header-social-item hidden-md-down">
              <a className="header-link" href="https://www.facebook.com/ActivaBtura" target="_blank">
                <i className="fab fa-facebook fa-lg"></i>
              </a>
            </div>
            <div className="header-item header-social-item hidden-md-down">
              <a className="header-link" href="https://www.instagram.com/activabtura" target="_blank">
                <i className="fab fa-instagram fa-lg"></i>
              </a>
            </div>
            <div className="header-item header-social-item hidden-md-down">
              <a className="header-link" href="https://twitter.com/ActivaBtura" target="_blank">
