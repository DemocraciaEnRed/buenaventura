      ...
      <div className='share-links'>
        <a
          ...
          className='icon-facebook'>
             <img src={`/lib/frontend/site/topic-layout/topic-article/icon_facebook.svg`} alt="Facebook"/>
          </a>
        <a
          ...
          className='icon-twitter'>
            <img src={`/lib/frontend/site/topic-layout/topic-article/icon_twitter.svg`} alt="Twitter"/>
          </a>
      </div>
    </div>
  )
