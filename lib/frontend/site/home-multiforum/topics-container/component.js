...
class TopicsContainer extends React.Component {
  ...
  render() {
    ...
    return (
      <section className='container consultas' id='consultas'>
        <div className="row">
        ...
        <div className="row">
          <div className="col-lg-12 text-center">
            <div className="hidden-xs" aria-label="Filtros">
              <div
            ...
            <div className="btn-group-vertical hidden-sm-up" aria-label="Filtros">
              <div
                className={`btn btn-item-filter ${activeFilter === 'byDate' ? 'selected' : ''}`}
                onClick={this.handleClick.bind(this, 'byDate')}
              >
