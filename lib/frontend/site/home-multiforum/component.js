      ...
      <div className='ext-site-home-multiforum'>
        ...
        <section className="intro-plataforma">
          <div className="container">
            ...
            <div className="row">
              <div className="offset-lg-1 col-lg-2 col-sm-6 col-xs-6 text-center home-icon-action">
                  <div className="icon-wrapper">
                    <img src="/lib/frontend/site/home-multiforum/icon-voto.svg" />
                  </div>
                  <h4>Voto</h4>
              </div>
              <div className="col-lg-2 col-sm-6 col-xs-6 text-center home-icon-action">
                  <div className="icon-wrapper">
              ...
              <div className="col-lg-2 offset-lg-0 offset-sm-3 offset-xs-3 col-sm-6 col-xs-6 text-center home-icon-action">
                  <div className="icon-wrapper">
                    <img src="/lib/frontend/site/home-multiforum/icon-voto.svg" />
                  </div>
                  <h4>Prioridad</h4>
