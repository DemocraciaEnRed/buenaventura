    ...
    return (
      <div className='ext-site-home-multiforum'>
        ...
        <section className='lead-paragraph'>
          <p>
          Somos el puente que une a la comunidad de Buenaventura con sus concejales y concejalas, donde podemos proponer y hacer visibles nuestras ideas para que conjuntamente con quienes nos representan en el gobierno, las hagamos realidad y continuemos activando nuestro territorio. 
          </p>
          <h3>La diversidad demuestra qué tan grandes podemos ser.</h3>
        </section>
