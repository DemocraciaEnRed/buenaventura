  ...
  <div className='container forum-card-container'>
    ...
    <div className='forum-slider-wrapper'>
      <h4 className='forum-slider-title'>
      {
        ...
        ||
        forum.extra.contentType === 'propuestas' && 'Las propuestas que comprenden esta comunidad son:'
        ||        
        (forum.extra.contentType === 'ejes' || forum.extra.contentType === undefined) && 'Los ejes que comprenden esta comunidad son:'
      }
      </h4>
