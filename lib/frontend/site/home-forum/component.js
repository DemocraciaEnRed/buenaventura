      ...
      <div className='ext-forum-home'>
        <section
          ...
          style={(forum.coverUrl && {
            backgroundImage: 'linear-gradient(to right, #ffab5e 0%, #ffe900 100%), url("' + forum.coverUrl + '")'
          }) || null}>
                ...
                <div className='col-md-12'>
                  <ol className='breadcrumb'>
                    <li className='breadcrumb-item'>
                      <Link to='/'>Comunidades Activas</Link>
                    </li>
          ...
          <div className='jumbotron_body'>
            <div className='container'>
              <Link className='pre-link' to='/'>Comunidades Activas</Link>
              <h1>{forum.title}</h1>
        ...
        <div className='container topics-container' >
          <h3>Las propuestas que existen en esta COMUNIDAD ACTIVA son:</h3>
          ...
          <div className='row'>
              <div className='col-lg-12'>
                <div className='topics-card-wrapper' ref='carrusel'>
                  {this.state.topics
        ...
        :
          <div className='container summary-container'>
            <h3>Qué puedes hacer con esta comunidad</h3>
            <p>{forum.summary}</p>
          </div>
        }
