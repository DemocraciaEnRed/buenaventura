...
export default class SignUp extends Component {
  ...
  handlePrivacyOptionChange = (changeEvent) => {
    this.setState({
      selectedPrivacyOption: changeEvent.target.value
    });
  }
            ...
            <div id='signup-form'>
              ...
              <FormAsync
                ...
                <div className='form-group aviso-privacidad'>
                  He leído y conocido <Link to='/ayuda/privacidad'>la política de tratamiento de datos personales</Link> y los <Link to='/ayuda/terminos-y-condiciones'>términos y condiciones</Link> de la plataforma. Otorgo mi autorización para el tratamiento de mis datos.
                  <div className='privacy-options'>
                    <div className='privacy-option'>
                      <input
                        type="radio"
                        value="acepto"
                        onChange={this.handlePrivacyOptionChange}
                        checked={this.state.selectedPrivacyOption === 'acepto'} />
                      Acepto
                    </div>
                    <div className='privacy-option'>
                      <input
                        ...
                        value="no-acepto"
                        onChange={this.handlePrivacyOptionChange}
                        checked={this.state.selectedPrivacyOption === 'no-acepto'} />
                      No acepto
                    </div>
                  </div>
                </div>
                <div className='form-group'>
                  <button
                    ...
                    type='submit'
                    disabled={this.state.selectedPrivacyOption !== 'acepto'}>
                    {t('signup.now')}
                  </button>
                  <button
